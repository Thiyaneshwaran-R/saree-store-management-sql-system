...
-- Sample sarees
INSERT INTO sarees VALUES (name, category, color, stock_quantity, price, discount)
...
-- Sample customers
INSERT INTO customers VALUES (name, email, phone, city)
...
-- Sample orders
INSERT INTO orders VALUES (customer_id, order_date, total_amount, status)
(1, '2025-06-18', 5000.00, 'Delivered'),
(2, '2025-06-19', 3200.00, 'Pending'),
(3, '2025-06-20', 1200.00, 'Shipped');

-- Sample order items
INSERT INTO order_items VALUES (order_id, saree_id, quantity, unit_price)
(1, 1, 2, 2500.00),
(2, 2, 1, 3200.00),
(3, 3, 1, 1200.00);

-- Sample payments
INSERT INTO payments VALUES (order_id, payment_date, payment_method, amount, payment_status)
